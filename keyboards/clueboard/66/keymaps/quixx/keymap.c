...
[_BL] = LAYOUT(
  ...
  KC_LCTL,KC_LGUI,KC_LALT,                       KC_SPC, KC_SPC,                  KC_RALT,MO(_FL),MO(_CL),          KC_LEFT,KC_DOWN,KC_RGHT),
...
[_FL] = LAYOUT(
  ...
  _______,_______,_______,_______,_______,_______,_______,KC_MUTE,_______,_______,_______,_______,_______,_______,        KC_PGUP,
  _______,_______,_______,                         _______,_______,              _______,MO(_FL),MO(_CL),        KC_HOME,KC_PGDN,KC_END),

  /* Keymap _CL: Control layer
   */
[_CL] = LAYOUT(
  KC_SLCK,KC_NLCK,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,        _______,
  _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,                _______,
  _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
  _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,        _______,
  _______,_______,_______,_______,                _______,_______,               _______,MO(_FL),MO(_CL),         _______,_______,_______),
};
